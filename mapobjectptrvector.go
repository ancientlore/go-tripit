...
type MapObjectPtrVector struct {
	vector.Vector
}

// AppendVector appends the entire vector x to the end of this vector.
func (p *MapObjectPtrVector) AppendVector(x *MapObjectPtrVector) {
	p.Vector.AppendVector(&x.Vector)
}

// At returns the i'th element of the vector.
func (p *MapObjectPtrVector) At(i int) *MapObject {
	return p.Vector.At(i).(*MapObject)
}

// Copy makes a copy of the vector and returns it.
func (p *MapObjectPtrVector) Copy() MapObjectPtrVector {
	return MapObjectPtrVector{p.Vector.Copy()}
}

// Do calls function f for each element of the vector, in order. The behavior of Do is undefined if f changes *p.
func (p *MapObjectPtrVector) Do(f func(elem *MapObject)) {
	p.Vector.Do(func(e interface{}) { f(e.(*MapObject)) })
}

// Insert inserts into the vector an element of value x before the current element at index i.
func (p *MapObjectPtrVector) Insert(i int, x *MapObject) {
	p.Vector.Insert(i, x)
}
...
func (p *MapObjectPtrVector) InsertVector(i int, x *MapObjectPtrVector) {
	p.Vector.InsertVector(i, &x.Vector)
}

// Last returns the element in the vector of highest index.
func (p *MapObjectPtrVector) Last() *MapObject {
	return p.Vector.Last().(*MapObject)
}

// Pop deletes the last element of the vector.
func (p *MapObjectPtrVector) Pop() *MapObject {
	return p.Vector.Pop().(*MapObject)
}

// Push appends x to the end of the vector.
func (p *MapObjectPtrVector) Push(x *MapObject) {
	p.Vector.Push(x)
}
...
func (p *MapObjectPtrVector) MarshalJSON() ([]byte, os.Error) {
	var a []*MapObject
	if p == nil {
		a = make([]*MapObject, 0)
	} else {
		a = make([]*MapObject, p.Len())
		for i := 0; i < p.Len(); i++ {
			a[i] = p.At(i)
		}
	}
...
func (p *MapObjectPtrVector) Data() []*MapObject {
	arr := make([]*MapObject, p.Len())
	var i int
	i = 0
	p.Do(func(v *MapObject) {
		arr[i] = v
		i++
	})
	return arr

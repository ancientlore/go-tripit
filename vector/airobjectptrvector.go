...
type AirObjectPtrVector struct {
	vector.Vector
}

// AppendVector appends the entire vector x to the end of this vector.
func (p *AirObjectPtrVector) AppendVector(x *AirObjectPtrVector) {
	p.Vector.AppendVector(&x.Vector)
}

// At returns the i'th element of the vector.
func (p *AirObjectPtrVector) At(i int) *AirObject {
	return p.Vector.At(i).(*AirObject)
}

// Copy makes a copy of the vector and returns it.
func (p *AirObjectPtrVector) Copy() AirObjectPtrVector {
	return AirObjectPtrVector{p.Vector.Copy()}
}

// Do calls function f for each element of the vector, in order. The behavior of Do is undefined if f changes *p.
func (p *AirObjectPtrVector) Do(f func(elem *AirObject)) {
	p.Vector.Do(func(e interface{}) { f(e.(*AirObject)) })
}

// Insert inserts into the vector an element of value x before the current element at index i.
func (p *AirObjectPtrVector) Insert(i int, x *AirObject) {
	p.Vector.Insert(i, x)
}
...
func (p *AirObjectPtrVector) InsertVector(i int, x *AirObjectPtrVector) {
	p.Vector.InsertVector(i, &x.Vector)
}

// Last returns the element in the vector of highest index.
func (p *AirObjectPtrVector) Last() *AirObject {
	return p.Vector.Last().(*AirObject)
}

// Pop deletes the last element of the vector.
func (p *AirObjectPtrVector) Pop() *AirObject {
	return p.Vector.Pop().(*AirObject)
}

// Push appends x to the end of the vector.
func (p *AirObjectPtrVector) Push(x *AirObject) {
	p.Vector.Push(x)
}
...
// requested capacity.
func (p *AirObjectPtrVector) Resize(length, capacity int) *AirObjectPtrVector {
	p.Vector = *p.Vector.Resize(length, capacity)
	return p
}

// Set sets the i'th element of the vector to value x.
func (p *AirObjectPtrVector) Set(i int, x *AirObject) {
	p.Vector.Set(i, x)
}

// Slice returns a new sub-vector by slicing the old one to extract slice [i:j]. The elements are copied.
// The original vector is unchanged.
func (p *AirObjectPtrVector) Slice(i, j int) *AirObjectPtrVector {
	v := p.Vector.Slice(i, j)
	return &AirObjectPtrVector{*v}
}
...
func (p *AirObjectPtrVector) MarshalJSON() ([]byte, os.Error) {
	var a []*AirObject
	if p == nil {
		a = make([]*AirObject, 0)
	} else {
		a = make([]*AirObject, p.Len())
		for i := 0; i < p.Len(); i++ {
			a[i] = p.At(i)
		}
	}
...
func (p *AirObjectPtrVector) Data() []*AirObject {
	arr := make([]*AirObject, p.Len())
	var i int
	i = 0
	p.Do(func(v *AirObject) {
		arr[i] = v
		i++
	})
	return arr
